...
import { CopyAble, PeachScrollView, PrimaryButton, Progress, RadioButtons, Screen, Text } from '../../components'
...
export const Referrals = () => {
  const { user, pointsBalance, availableRewards, selectedReward, setSelectedReward, redeem } = useReferralsSetup()
