...
export const MobilePendingActionRefundContractEscrowSuccess = () => {
      ...
      <View style={tw`flex-1 justify-between px-4`}>
        <View style={tw`flex-1 items-center justify-center`}>
          ...
          >
            ...
            >
              {i18n(
                "connectToDesktop.mobilePendingActions.refundEscrow.successTitle",
              )}
            </PeachText>
            ...
            >
              {i18n(
                "connectToDesktop.mobilePendingActions.refundEscrow.successDescription",
              )}
            </PeachText>
          </Animated.View>
        </View>
