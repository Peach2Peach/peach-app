...
export default ({ route, navigation }: Props): ReactElement => {
  ...
  const buttonText: string|JSX.Element = offer.funding.status === 'MEMPOOL'
  ...
  useFocusEffect(useCallback(() => {
    if (!account.settings.showDisputeDisclaimer) return
      ...
      {updatePending
        ...
        : offer.id && escrow && fundingStatus && !fundingError
          ? <View>
            ...
            <FundingView escrow={escrow} amount={offer.amount}
