...
describe('isPSBTForBatch', () => {
  ...
  const psbt = constructPSBT(wallet, undefined, { value: 100000, address: contract.releaseAddress })
  const batchPSBT = constructPSBT(wallet, { sighashType: SIGHASH.SINGLE_ANYONECANPAY }, { value: 10000 })
