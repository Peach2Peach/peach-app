...
describe('buildReportMessage', () => {
  it('returns a message for report', () => {
    const message = buildReportMessage({ message: 'test', shareDeviceID: false, shareLogs: false })
  ...
  it('returns a message for report with device id and log sharing', () => {
    const message = buildReportMessage({ message: 'test', shareDeviceID: true, shareLogs: true })
