...
describe("getOfferColor", () => {
  it('should return "black" when tradeStatus is "tradeCanceled"', () => {
    expect(
      getOfferColor({ ...contractSummary, tradeStatus: "tradeCanceled" }),
    ).toBe("black");
  });
  it('should return "black" when tradeStatus is "offerCanceled"', () => {
    expect(
      getOfferColor({ ...contractSummary, tradeStatus: "offerCanceled" }),
    ).toBe("black");
  });
  ...
  it('should return "error" when tradeStatus is "dispute"', () => {
    expect(getOfferColor({ ...contractSummary, tradeStatus: "dispute" })).toBe(
      "error",
    );
  });
  it('should return "warning" when tradeStatus is "releaseEscrow"', () => {
    expect(
      getOfferColor({ ...contractSummary, tradeStatus: "releaseEscrow" }),
    ).toBe("warning");
  });
  ...
  it('should return "black" when tradeStatus is "confirmCancelation"', () => {
    expect(
      getOfferColor({ ...contractSummary, tradeStatus: "confirmCancelation" }),
    ).toBe("black");
  });
  ...
  it('should return "primary-mild" when tradeStatus is "searchingForPeer"', () => {
    expect(
      getOfferColor({ ...contractSummary, tradeStatus: "searchingForPeer" }),
    ).toBe("primary-mild");
  });
  it('should return "primary-mild" when tradeStatus is "offerHidden"', () => {
    expect(
      getOfferColor({ ...contractSummary, tradeStatus: "offerHidden" }),
    ).toBe("primary-mild");
  });
  ...
  it('should return "warning" when the tradeStatus is "paymentTooLate"', () => {
    expect(
      getOfferColor({ ...contractSummary, tradeStatus: "paymentTooLate" }),
    ).toBe("warning");
  });
  ...
  it('should return "primary" when none of the above', () => {
    expect(getOfferColor({ ...contractSummary, tradeStatus: "rateUser" })).toBe(
      "primary",
    );
  });
});
