...
export const SecurityInfo = () => (
  <View style={tw`grow`}>
    <PeachText style={tw`text-center subtitle-1`}>{i18n('settings.backups.seedPhrase.toRestore')}</PeachText>
    <PeachText style={tw`h6 text-center mt-[45px]`}>{i18n('settings.backups.seedPhrase.keepSecure')}</PeachText>
