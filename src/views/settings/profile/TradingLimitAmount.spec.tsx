...
describe('TradingLimitAmount', () => {
  ...
  it('should render correctly for daily', () => {
    renderer.render(<TradingLimitAmount amount={10} limit={100} displayCurrency="EUR" type="daily" />)
    expect(renderer.getRenderOutput()).toMatchSnapshot()
  })
  it('should render correctly for monthly', () => {
    renderer.render(<TradingLimitAmount amount={100} limit={1000} displayCurrency="EUR" type="monthly" />)
    expect(renderer.getRenderOutput()).toMatchSnapshot()
  })
