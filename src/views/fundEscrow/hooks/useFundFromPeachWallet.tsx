    ...
    async ({
      ...
      try {
        ...
        try {
          ...
          const amountToConfirm = potentialTx
            .output()
            .reduce((sum, item) => sum + Number(item.value.toSat()), 0);
