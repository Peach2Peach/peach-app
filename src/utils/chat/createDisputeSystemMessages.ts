...
import { getOfferHexIdFromContract, getOfferIdFromContract } from '../contract'
      ...
      messages = messages.concat([
        createSystemMessage(
          ...
          [
            ...
            i18n('chat.systemMessage.provideMoreInformation.2', getOfferHexIdFromContract(contract)),
          ].join('\n\n'),
        ),
      ])
    }
