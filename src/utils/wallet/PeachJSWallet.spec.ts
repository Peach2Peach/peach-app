...
describe("PeachJSWallet", () => {
  ...
  it("finds key pair by address and stores scanned addresses", () => {
    ...
    expect(keyPair?.publicKey.toString("hex")).toBe(
      "03f5c7061bd2ca963c20edc0f8e09c42a9a5b35df3f708d3339446f1d00656b67c",
    );
  ...
  it("signs an arbitrary message", () => {
    ...
    expect(signature).toBe(
      "H/3SBIrDhI686xf6q40H1aQCI9DHF1zD4YKHuG3Efq8XK3rDDA0zYCQQ31XERBZqEq+2DUOupYYCIahvYOwbJ3s=",
    );
  });
  it("signs an arbitrary message with index", () => {
    ...
    expect(signature).toBe(
      "H1cN5gQpMeLAsid1ZnUIJxEVC5+geRao9yeT9V88rtHfe4bEvglz8hSwnWCuMjjHHYCgBGKssceWPUQKKrpThRE=",
    );
  });
