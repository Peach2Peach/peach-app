...
describe("groupChars", () => {
  ...
  it("should handle large strings", () => {
    expect(groupChars("1234567890123456789", 3)).toEqual(
      "1 234 567 890 123 456 789",
    );
    expect(groupChars("1234567890123456789", 10)).toEqual(
  ...
  it("should handle strings with non-alphanumeric characters", () => {
    expect(groupChars("1234567890!@#$%^&*()", 2)).toEqual(
      "12 34 56 78 90 !@ #$ %^ &* ()",
    );
    expect(groupChars("1234567890!@#$%^&*()", 3)).toEqual(
      "12 345 678 90! @#$ %^& *()",
    );
    expect(groupChars("1234567890!@#$%^&*()", 4)).toEqual(
      "1234 5678 90!@ #$%^ &*()",
    );
  });
