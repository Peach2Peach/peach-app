...
export const PaymentLogos = {
  ...
  orangeMoney,
  papara,
  paraguayBankTransfer: placeholder,
  payday: placeholder,
  paylib,
  paypal,
  paysera,
  ...
  vipps,
  wave,
  westernUnion: placeholder,
  wirepay: placeholder,
  wise,
  guatemalaBankDeposit: placeholder,
  chileBankDeposit: placeholder,
  peruBankDeposit: placeholder,
  djamo: placeholder,
  apaym: placeholder,
  kcbBankKenya: placeholder,
  bankTransferSuriname: placeholder,
  perfectMoney: placeholder,
  payeer: placeholder,
  yooMoney: placeholder,
  stp: placeholder,
  spei: placeholder,
  daviPlata: placeholder,
  tigoPesa: placeholder,
  tigoMoneyHonduras: placeholder,
  tigoMoneyBolivia: placeholder,
  tigoMoneyElSalvador: placeholder,
  tigoMoneyParaguay: placeholder,
