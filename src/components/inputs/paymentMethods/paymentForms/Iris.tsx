...
export const Iris = ({ forwardRef, data, currencies = [], onSubmit, setStepValid }: FormProps): ReactElement => {
  ...
  const buildPaymentData = (): PaymentData & IrisData => ({
    id: data?.id || `iris-${new Date().getTime()}`,
    label,
    type: 'iris',
    phone,
    beneficiary,
