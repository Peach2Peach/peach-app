...
export const Paylib = ({ forwardRef, data, currencies = [], onSubmit, setStepValid }: FormProps): ReactElement => {
  ...
  const buildPaymentData = (): PaymentData & PaylibData => ({
    id: data?.id || `paylib-${new Date().getTime()}`,
    label,
    type: 'paylib',
    phone,
    beneficiary,
