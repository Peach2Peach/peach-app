...
export const Lydia = ({ forwardRef, data, currencies = [], onSubmit, setStepValid }: FormProps): ReactElement => {
  ...
  const buildPaymentData = (): PaymentData & LydiaData => ({
    id: data?.id || `lydia-${new Date().getTime()}`,
    label,
    type: 'lydia',
    phone,
    beneficiary,
