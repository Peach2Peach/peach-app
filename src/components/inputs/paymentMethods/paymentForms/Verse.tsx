...
export const Verse = ({ forwardRef, data, currencies = [], onSubmit, setStepValid }: FormProps): ReactElement => {
  ...
  const buildPaymentData = (): PaymentData & VerseData => ({
    id: data?.id || `verse-${new Date().getTime()}`,
    label,
    type: 'verse',
    phone,
    beneficiary,
