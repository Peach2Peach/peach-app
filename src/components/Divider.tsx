...
export const Divider = ({ type = 'light', align = 'left', icon, iconAlign = 'left', text, style }: Props) => (
  <View style={[tw`flex-row items-center`, style]}>
    ...
    {align === 'center' && <HorizontalLine style={[tw`flex-grow self-center`, type === 'error' && tw`bg-error-mild`]} />}
    {!!text && (
      <Text
        style={[
    ...
    <HorizontalLine style={[tw`flex-grow self-center`, type === 'error' && tw`bg-error-mild`]} />
