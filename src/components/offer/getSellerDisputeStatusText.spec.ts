...
describe('getSellerDisputeStatusText', () => {
  it('should return the correct text for a lost dispute', () => {
    ...
    expect(getSellerDisputeStatusText(contract)).toBe(i18n('contract.seller.disputeLost.releaseEscrow'))
  })
  it('should return the correct text for a lost dispute where the escrow has been released', () => {
    ...
    expect(getSellerDisputeStatusText(contract)).toBe(i18n('contract.seller.disputeLost.escrowReleased'))
  })
  it('should return the correct text for a won dispute where the seller can republish', () => {
    ...
    expect(getSellerDisputeStatusText(contract)).toBe(i18n('contract.seller.disputeWon.refundOrRepublish'))
  })
  it('should return the correct text for a won dispute where the seller cannot republish', () => {
    ...
    expect(getSellerDisputeStatusText(contract)).toBe(i18n('contract.seller.disputeWon.refund'))
  })
})
