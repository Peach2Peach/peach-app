  ...
  plugins: [
    plugin(({ addUtilities }) => {
      addUtilities({
        ...
        "drawer-title":
          "font-baloo-bold text-base leading-relaxed tracking-widest uppercase",
        "subtitle-0": "font-baloo-semibold text-xl tracking-normal",
        "subtitle-1":
          "font-baloo-semibold text-base leading-xl tracking-normal",
        ...
        "button-large":
          "font-baloo-semibold text-sm leading-lg tracking-wider uppercase",
        "button-medium":
          "font-baloo-semibold text-xs leading-base tracking-wider uppercase",
        "button-small":
          "font-baloo-semibold text-2xs leading-sm tracking-wider uppercase",
        settings:
          "font-baloo-semibold text-xl lowercase leading-2xl tracking-normal",
        ...
        "input-title":
          "font-baloo text-base tracking-normal font-bold leading-23px",
        tooltip: "font-baloo-medium text-xs leading-xs tracking-normal",
        notification:
          "font-baloo-semibold text-3xs tracking-superTightest leading-sm text-center",
      });
    }),
  ],
});
