...
describe('DisputeRaisedSuccess', () => {
  it('opens dispute raised success popup for buyer', () => {
    ...
    expect(queryByText('The seller and the mediator have been notified. Keep an eye on the chat!')).toBeTruthy()
  })
  it('opens dispute raised success popup for seller', () => {
    const { queryByText } = render(<DisputeRaisedSuccess view="seller" />)
    expect(queryByText('The buyer and the mediator have been notified. Keep an eye on the chat!')).toBeTruthy()
  })
  it('closes popup', () => {
