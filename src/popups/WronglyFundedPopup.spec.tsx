...
describe('useShowWronglyFundedPopup', () => {
  ...
  it('uses WrongFundingAmount as content if there is only one utxo', () => {
    const { queryByText } = render(<WronglyFundedPopup sellOffer={wronglyFundedOffer} />)
  ...
  it('opens Incorrect Funding popup when funded with multiple transactions', () => {
    const { queryByText } = render(<WronglyFundedPopup sellOffer={incorrectlyFundedOffer} />)
  ...
  it('starts refund process', () => {
    const { getByText } = render(<WronglyFundedPopup sellOffer={wronglyFundedOffer} />)
