...
import { NUMBER_OF_FREE_TRADES, POINTS_PER_FREE_TRADE } from '../../views/referrals/constants'
    ...
    onMutate: async () => {
      ...
      queryClient.setQueryData<User>(['user', 'self'], (old) => {
        ...
        return {
          ...
          bonusPoints: (old?.bonusPoints || 0) - POINTS_PER_FREE_TRADE * NUMBER_OF_FREE_TRADES,
        }
      })
      return { previousData }
    },
