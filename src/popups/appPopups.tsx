...
export const appPopups = {
  offerTaken: { title: i18n('search.popups.offerTaken.title'), content: i18n('search.popups.offerTaken.text') },
  matchUndone: { title: i18n('search.popups.matchUndone.title'), content: i18n('search.popups.matchUndone.text') },
