...
describe('round', () => {
  ...
  it('rounds values to one digit after the comma', async () => {
  ...
  it('rounds values to two digits after the comma', async () => {
  ...
  it('rounds values to three and above digits after the comma', async () => {
