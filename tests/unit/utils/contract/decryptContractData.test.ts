import { decryptContractData } from '../../../../src/utils/contract'
import { decryptSymmetricKey } from '../../../../src/views/contract/helpers/decryptSymmetricKey'
import { getPaymentData } from '../../../../src/views/contract/helpers/getPaymentData'

jest.mock('../../../../src/views/contract/helpers/getPaymentData', () => ({
  getPaymentData: jest.fn(),
}))
jest.mock('../../../../src/views/contract/helpers/decryptSymmetricKey', () => ({
