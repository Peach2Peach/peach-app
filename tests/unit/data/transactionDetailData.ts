...
export const createTransaction = ({ txid, hex = txid, received, sent, fee, confirmationTime }: Props) => {
...
export const transactionWithoutRBF1: Transaction = {
  ...
  vin: [
    {
      ...
      prevout: {
        ...
        scriptpubkey_asm: 'OP_HASH160 OP_PUSHBYTES_20 0a5dc8bc7a13f2cd6d68c715e317d418f21e81c1 OP_EQUAL',
        scriptpubkey_type: 'p2sh',
        scriptpubkey_address: '32dq2hQBuE3tQbNR2TYHLWXKfXqcTZGsFj',
        value: 1032151,
      },
      scriptsig: '1600142fecca63092f639cb94aa7e60d39d64eb7954c5b',
      scriptsig_asm: 'OP_PUSHBYTES_22 00142fecca63092f639cb94aa7e60d39d64eb7954c5b',
      witness: [
      ...
      is_coinbase: false,
      sequence: 4294967295,
      inner_redeemscript_asm: 'OP_0 OP_PUSHBYTES_20 2fecca63092f639cb94aa7e60d39d64eb7954c5b',
    },
    {
      ...
      prevout: {
        ...
        scriptpubkey_asm: 'OP_HASH160 OP_PUSHBYTES_20 00bcc6d503ccc9901fe0f36cf50bcaaebb28f0b5 OP_EQUAL',
        scriptpubkey_type: 'p2sh',
        scriptpubkey_address: '31kv4yg9k4nUM8zGFFECE1U8CP2zNf7mZs',
        value: 332068,
      },
      scriptsig: '16001405975f547907417483fda382ad60898e81af6dcd',
      scriptsig_asm: 'OP_PUSHBYTES_22 001405975f547907417483fda382ad60898e81af6dcd',
      witness: [
      ...
      is_coinbase: false,
      sequence: 4294967295,
      inner_redeemscript_asm: 'OP_0 OP_PUSHBYTES_20 05975f547907417483fda382ad60898e81af6dcd',
    },
    {
      ...
      prevout: {
        ...
        scriptpubkey_asm: 'OP_HASH160 OP_PUSHBYTES_20 97dbc260cb84e0817db98a94ac620957722c6b9d OP_EQUAL',
        scriptpubkey_type: 'p2sh',
        scriptpubkey_address: '3FXyDeqqgF7fVyZGnJZQQe9tXCisxK9tLt',
        value: 71746,
      },
      scriptsig: '160014c4fc25295248438adccf6b40354bed98f538a269',
      scriptsig_asm: 'OP_PUSHBYTES_22 0014c4fc25295248438adccf6b40354bed98f538a269',
      witness: [
      ...
      is_coinbase: false,
      sequence: 4294967295,
      inner_redeemscript_asm: 'OP_0 OP_PUSHBYTES_20 c4fc25295248438adccf6b40354bed98f538a269',
    },
  ],
  vout: [
    {
      scriptpubkey: 'a914a7e14412b327e3ffee02c1f817e28fc8ff52619b87',
      scriptpubkey_asm: 'OP_HASH160 OP_PUSHBYTES_20 a7e14412b327e3ffee02c1f817e28fc8ff52619b OP_EQUAL',
      scriptpubkey_type: 'p2sh',
    ...
    },
    {
      ...
      scriptpubkey_asm: 'OP_HASH160 OP_PUSHBYTES_20 54f99aee545ec4a4d5d27054fb6c0763d0fff61b OP_EQUAL',
      scriptpubkey_type: 'p2sh',
  ...
  status: {
    confirmed: true,
    block_height: 796381,
    block_hash: '000000000000000000006aa27ca0320bd02d58c04d2c9da923c1bb71574e070d',
...
export const transactionWithoutRBF2: Transaction = {
  ...
  vin: [
    {
      ...
      prevout: {
        ...
        scriptpubkey_asm: 'OP_0 OP_PUSHBYTES_20 803b53fc395b14e705658b26fe23715ccc8f72b8',
  ...
  vout: [
    {
      scriptpubkey: '51206c09baf41ba57afd229faa252c5d8c122a9613f70c5874625c81e894ef4f2828',
      scriptpubkey_asm: 'OP_PUSHNUM_1 OP_PUSHBYTES_32 6c09baf41ba57afd229faa252c5d8c122a9613f70c5874625c81e894ef4f2828',
      scriptpubkey_type: 'v1_p2tr',
      scriptpubkey_address: 'bc1pdsym4aqm54a06g5l4gjjchvvzg4fvylhp3v8gcjus85ffm609q5qkj09gr',
      value: 1473300,
    },
    {
      scriptpubkey: '0014803b53fc395b14e705658b26fe23715ccc8f72b8',
...
export const transactionWithRBF1: Transaction = {
  ...
  vin: [
    {
      ...
      vout: 16,
      prevout: {
        scriptpubkey: '512022418d48e03d3033eaff5e66d7469ad498e0d2756d82717c146a5e0d70dbfba5',
        scriptpubkey_asm:
          'OP_PUSHNUM_1 OP_PUSHBYTES_32 22418d48e03d3033eaff5e66d7469ad498e0d2756d82717c146a5e0d70dbfba5',
        scriptpubkey_type: 'v1_p2tr',
        scriptpubkey_address: 'bc1pyfqc6j8q85cr86hltendw3566jvwp5n4dkp8zlq5df0q6uxmlwjs9uku9q',
        value: 1870,
      },
      scriptsig: '',
      scriptsig_asm: '',
  ...
  vout: [
    {
      ...
      scriptpubkey_asm: 'OP_0 OP_PUSHBYTES_20 f001c49c6e329d6dec2a8922ce44000c46e083d8',
      scriptpubkey_type: 'v0_p2wpkh',
  ...
  status: {
    confirmed: true,
    block_height: 796382,
    block_hash: '00000000000000000000d880221955f5d1413bf28edcfd54c22872b19f7ad592',
...
export const transactionWithRBF2: Transaction = {
  ...
  vout: [
    {
      ...
      scriptpubkey_asm: 'OP_0 OP_PUSHBYTES_20 5e589380d21a931b70a757e2aa8e0bdda694b1dd',
      scriptpubkey_type: 'v0_p2wpkh',
  ...
  status: {
    confirmed: true,
    block_height: 796391,
    block_hash: '000000000000000000034a8b67ed40a93fe6878986b41a5bb371dfafb9d842b6',
