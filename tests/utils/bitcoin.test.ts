...
describe('parseBitcoinRequest', () => {
  it('parses valid bitcoin requests', () => {
    const request = 'bitcoin:bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdq?amount=0.00001&message=Test&time=1649846322&exp=604800'
    const parsedRequest = {
  ...
  it('should return null for lightning invoices', () => {
    const request = ''
    const parsedRequest = {}
    deepStrictEqual(parseBitcoinRequest(request), parsedRequest)
  })
